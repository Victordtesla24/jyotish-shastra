...
check_git_repo() {
    if [ ! -d ".git" ]; then
        ...
        print_info "Please run this script from the root of the jyotish-shastra project"
        exit 1
    fi
...
<head>
    ...
    <title>Jyotish Shastra - Project Comparison Report</title>
    <style>
        body {
...
<body>
    <div class="container">
        <div class="header">
            <h1>🔍 Jyotish Shastra Project Comparison</h1>
...
EOF
    ...
    cat >> "$COMPARISON_REPORT" << EOF
        ...
        <div class="footer">
            ...
            <p>Generated by Project Comparison and Restoration Script v1.0</p>
        </div>
    </div>
</body>
</html>
...
main() {
    # Header
    print_header "JYOTISH SHASTRA - PROJECT COMPARISON & RESTORATION"
